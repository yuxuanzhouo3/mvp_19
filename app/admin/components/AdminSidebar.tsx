...
const navItems = [
  ...
  { href: "/admin/reports", label: "举报管理", icon: AlertTriangle },
  {
    ...
    children: [
      ...
      { href: "/admin/ads/video-deduction", label: "视频演绎", icon: Video },
    ],
  },
          ...
          if (item.children) {
            return (
              <div key={item.label} className="space-y-1">
                <div className="flex items-center justify-between px-4 py-3 rounded-lg transition-colors cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700">
